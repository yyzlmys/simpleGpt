...
class CodeChat:
    ...
    def init_prompt(self):
        prompt_template_str: str = '''
            ...
            Before writing or suggesting code, you conduct a deep-dive review of the existing code and describe how it works between <CODE_REVIEW> tags(Note the line break). Once you have completed the review, you produce a careful plan for the change in <PLANNING> tags(Note the line break). Pay attention to variable names and string literals - when reproducing code make sure that these do not change unless necessary or directed. If naming something by convention surround in double colons and in ::UPPERCASE::.
